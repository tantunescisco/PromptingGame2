Instructions for Completion page.
...
- Centerpiece: A horizontal "Evolution Timeline" carousel. Display all 5 characters side-by-side from left to right (Scribe, Philosopher, Engineer, Hacker, Star Archon). They should all be rendered in a uniform, glowing golden silhouette or holograph style to show they have been "unlocked" or mastered.
- Typography: Large, elegant, futuristic serif or clean sans-serif header text that reads: "CIVILIZATION SYNCHRONIZED" or "MASTER PROMPT ENGINEER CODE UNLOCKED".

UI Layout Components:
1. Header Section: Big congratulatory title and a subtitle celebrating their new skills.
2. Stat Card Grid: Three clean, glassmorphic cards showing:
   - "Total Score / Accuracy Rate"
   - "Rank Achieved" (e.g., "Grand Architect of Prompting")
...
- Score 80-99%: "Quantum Logic Engineer"
- Score 60-79%: "Industrial Automator"
- Score <60%: "Apprentice Clay Scribe"

Interactive States to Implement:
1. Mounting Sequence: When this screen loads, trigger a 2-second sequential fade-in. Character 1 fades in first, then Character 2, up to Character 5, creating a satisfying "timeline building" visual effect.
...
- Hover States: When hovering over any of the 5 timeline characters, they should gently scale up (105%), shift from a golden silhouette to their full, vibrant level-colored avatar, and display a tool-tip listing the prompt topics mastered in that level (e.g., Level 3: "Chain-of-Thought & Decomposition").
